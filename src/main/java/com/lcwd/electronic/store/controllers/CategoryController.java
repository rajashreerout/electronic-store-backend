...
public class CategoryController {
    ...
    //get live products of categories
    @GetMapping("/{categoryId}/products/live")
    public ResponseEntity<PageableResponse<ProductDto>> getLiveProductsOfCategory(
            @PathVariable String categoryId,
            @RequestParam(value = "pageNumber", defaultValue = "0", required = false) int pageNumber,
            @RequestParam(value = "pageSize", defaultValue = "10", required = false) int pageSize,
            @RequestParam(value = "sortBy", defaultValue = "title", required = false) String sortBy,
        ...
        PageableResponse<ProductDto> response = productService.getAllLiveProductsOfCategory(categoryId,pageNumber,pageSize,sortBy,sortDir);
        return new ResponseEntity<>(response, HttpStatus.OK);
